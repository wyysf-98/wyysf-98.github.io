/* jquery.poptrox.js v2.5.2-dev | (c) @ajlkn | github.com/ajlkn/jquery.poptrox | MIT licensed */ !(function (
  e
) {
            ...
            switch (((p = t.src.match(/\/\/[a-z0-9\.]+\/(.*)/)), t.type)) {
              case "iframe":
                (wid = e(window).width()),
                  ...
                  t.object
                    ...
                    .css("cursor", "auto"),
                  (t.width && t.height) ||
                    ((t.width = Math.min(0.9 * wid, 800) + ""),
                    (t.height = Math.min(0.54 * wid, 452) + ""));
                break;
                case "video":
                    (wid = e(window).width()),
                      (t.object = e('<video src="" frameborder="0"></video>')),
                      t.object
                        .on("click", function (e) {
                          e.stopPropagation();
                        })
              ...
              case "youtube":
                ...
                const isChinaMainland = async () => {
                  ...
                  return data2.trim() === "CN";
                };
                isChinaMainland().then((result) => {
                  if (result && p[1].split("||")[1]) {
                    t.src =
                      p[1].split("||")[1] + (t.options ? "?" + t.options : "");
                    console.log("change the video.src to bilibili");
                  } else {
                    console.log("do not change the video.src");
                  }
                });
                break;
              case "vimeo":
